...
democrat <- rename(democrat, c(Persons.under.18.years..percent..2014 = "under18",
...
#normalize variables
democrat$median_income <- democrat$median_income/1000
democrat$fraction_votes <- democrat$fraction_votes*100

#isolate Hillary and Bernie sets
Hillary <- subset(democrat, candidate == "Hillary Clinton")
Bernie <- subset(democrat, candidate == "Bernie Sanders")
